...
',
  ...
  'plugins.importexport.medra.senderTask.name' => 'Tarefa de registro automático do mEDRA',
  'plugins.importexport.medra.settings.form.testMode.description' => 'Use a API de teste mEDRA (ambiente de teste) para o registro do DOI. Por favor, não esqueça de remover esta opção para a produção.',
);