...
<p>Los paquetes de lenguaje se pueden descargar manualmente desde la página web de PKP <a href="https://pkp.sfu.ca"></a>.</p>',
  ...
  'admin.contexts.form.create.success' => '{$name} se ha creado con éxito.',
  'admin.settings.info.success' => 'La información del sitio ha sido actualizada con éxito.',
  'admin.settings.config.success' => 'Los ajustes de configuración del sitio se han actualizado correctamente.',
  'admin.settings.appearance.success' => 'Los ajustes de apariencia del sitio se han actualizado correctamente.',
  'admin.contexts.form.edit.success' => '{$name} se ha editado con éxito.',
);