<?php
/* Smarty version 3.1.34-dev-7, created on 2020-10-19 22:47:53
  from 'app:controllersmodalseditorDe' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f8e17992ea587_82902440',
...
function content_5f8e17992ea587_82902440 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
" />
		...
		<?php if ($_smarty_tpl->tpl_vars['decision']->value != @constant('SUBMISSION_EDITOR_DECISION_PENDING_REVISIONS') && $_smarty_tpl->tpl_vars['decision']->value != @constant('SUBMISSION_EDITOR_DECISION_RESUBMIT')) {?>
...
" />
	<?php } else { ?>
		<?php if ($_smarty_tpl->tpl_vars['decision']->value == @constant('SUBMISSION_EDITOR_DECISION_PENDING_REVISIONS')) {?>
			<?php $_smarty_tpl->_assignInScope('checkedRevisions', "1");?>
		<?php } elseif ($_smarty_tpl->tpl_vars['decision']->value == @constant('SUBMISSION_EDITOR_DECISION_RESUBMIT')) {?>
...
ob_start();?>
			<ul class="checkbox_and_radiobutton">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"radio",'id'=>"decisionRevisions",'name'=>"decision",'value'=>@constant('SUBMISSION_EDITOR_DECISION_PENDING_REVISIONS'),'checked'=>$_smarty_tpl->tpl_vars['checkedRevisions']->value,'label'=>"editor.review.NotifyAuthorRevisions"),$_smarty_tpl ) );?>

				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"radio",'id'=>"decisionResubmit",'name'=>"decision",'value'=>@constant('SUBMISSION_EDITOR_DECISION_RESUBMIT'),'checked'=>$_smarty_tpl->tpl_vars['checkedResubmit']->value,'label'=>"editor.review.NotifyAuthorResubmit"),$_smarty_tpl ) );?>
