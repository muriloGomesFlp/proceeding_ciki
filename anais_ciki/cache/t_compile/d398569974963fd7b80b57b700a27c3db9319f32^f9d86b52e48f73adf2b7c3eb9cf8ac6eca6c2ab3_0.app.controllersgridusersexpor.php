...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_5fabf76ee38334_91945560',
...
function content_5fabf76ee38334_91945560 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
<?php echo '</script'; ?>
>
<form class="pkp_form filter" id="userSearchForm" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_COMPONENT'),'component'=>"grid.settings.user.UserGridHandler",'op'=>"fetchGrid"),$_smarty_tpl ) );?>
" method="post">
