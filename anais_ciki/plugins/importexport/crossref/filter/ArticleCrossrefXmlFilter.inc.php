...
class ArticleCrossrefXmlFilter extends IssueCrossrefXmlFilter {
	 ...
	 * @return DOMElement
	 */
	function CreateProceedingsSeriesNode($doc, $submission) {
		$deployment = $this->getDeployment();
		...
		$journalIssueNode = parent::CreateProceedingsSeriesNode($doc, $issue);
	...
	function createJournalArticleNode($doc, $submission) {
		...
		$journalArticleNode = $doc->createElementNS($deployment->getNamespace(), 'conference_paper');
